...
CREATE TABLE `anggota` (
  ...
  `no_penduduk` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tempat` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tgl_lahir` date NOT NULL,
  `kelurahan_id` bigint unsigned NOT NULL,
  `agama` varchar(9) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  KEY `anggota_kelurahan_id_foreign` (`kelurahan_id`),
  CONSTRAINT `anggota_kelurahan_id_foreign` FOREIGN KEY (`kelurahan_id`) REFERENCES `kelurahan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `distrik` (
  ...
  `nm_distrik` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `distrik_kota_id_foreign` (`kota_id`),
  CONSTRAINT `distrik_kota_id_foreign` FOREIGN KEY (`kota_id`) REFERENCES `kota` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `kelurahan` (
  ...
  `nm_kelurahan` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `keuangan` (
  ...
  `tgl` date NOT NULL,
  `keterangan` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `debet` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kredit` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `saldo` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `kota` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nm_kota` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `pengurus` (
  ...
  `jenkel` varchar(9) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tempat` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tgl_lahir` date NOT NULL,
...
INSERT INTO `role_user` VALUES (1,1,'App\\Models\\User'),(3,2,'App\\Models\\User');
