                        ...
                        <div class="bg-white rounded10 shadow-lg">
                            ...
                            <div class="p-40">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" id="name" name="name"
                                                class="form-control ps-15 bg-transparent" placeholder="Full Name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="password_confirmation" id="password_confirmation"
                                                name="password_confirmation" class="form-control ps-15 bg-transparent"
                                ...
                                <div class="text-center">
                                    <p class="mt-15 mb-0">Sudah memiliki akun?<a href="{{ route('login') }}"
