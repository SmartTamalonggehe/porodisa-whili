            ...
            <div class="col-12">
                ...
                @else
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form class="form" novalidate action="{{ route('anggotaUser.store') }}"
                                method="post">
                                @csrf
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="no_penduduk"
                                                    name="no_penduduk" placeholder="Masukan No Penduduk">
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="kelurahan_id">
                                                    ...
                                                    @foreach ($kelurahan as $item)
                                                        <option value="{{ $item->id }}">{{ $item->nm_kelurahan }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
